...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2024 at 06:47 PM
...
(11, 'Bhagvat Mutthe', 'CTS', 'thebmpatil@gmail.com', '7574556213', 99, 'Dhankawadi\r\nSumangal Apt', 'Pune', 'Maharashtra', '411043', 'Bhagvat Mutthe', 'CTS', '215615213', 99, 'Dhankawadi\r\nSumangal Apt', 'Pune', 'Maharashtra', '411043', 'Bhagvat Mutthe', 'CTS', '215615213', 99, 'Dhankawadi\r\nSumangal Apt', 'Pune', 'Maharashtra', '411043', 'e10adc3949ba59abbe56e057f20f883e', '614481b53c1608fbf5e5c49b6840e8de', '2024-11-10 12:03:16', '1731268996', 1);
...
(6, 103, 'Iphone 15 pro Blue', '', '', '2', '7542', '1731269108');
...
(56, 11, 'Bhagvat Mutthe', 'thebmpatil@gmail.com', '2024-11-10 12:05:08', '', 15140, '', '', '', '', 'DOne na bhai', 'Bank Deposit', 'Completed', 'Completed', '1731269108');
...
(103, 'Iphone 15 pro Blue', '94156', '7542', 30, 'product-featured-.jpg', '<p>lrsbdf hjas&nbsp; fb abif h fdhja ff</p>', '<p>fdaggfvdsvv dfsgsd</p>', '<p>Very best phopne in thr world</p>', '<p>Broken</p>', '<p>no</p>', 4, 1, 1, 73);
...
CREATE TABLE `tbl_settings` (
  ...
  `total_recent_post_footer` tinyint(4) NOT NULL,
  `total_popular_post_footer` tinyint(4) NOT NULL,
  `total_recent_post_sidebar` tinyint(4) NOT NULL,
  `total_popular_post_sidebar` tinyint(4) NOT NULL,
  `total_featured_product_home` tinyint(4) NOT NULL,
  `total_latest_product_home` tinyint(4) NOT NULL,
  `total_popular_product_home` tinyint(4) NOT NULL,
